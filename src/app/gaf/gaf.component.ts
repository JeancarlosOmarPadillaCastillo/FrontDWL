...
@Component({
  ...
  imports: [MainComponent,
    SideBarLeftComponent, MainComponent, SideBarLeftComponent],
  templateUrl: './gaf.component.html',
  styleUrl: './gaf.component.css'
})
export class GafComponent implements OnInit {
