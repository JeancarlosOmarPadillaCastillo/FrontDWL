...
@Component({
  selector: 'app-ver-historial-epp-sst',
  standalone: true,
  imports: [
    MatButton,
    MatCard,
  ...
  templateUrl: './ver-historial-epp-sst.component.html',
  styleUrl: './ver-historial-epp-sst.component.css'
})
export class VerHistorialEppSstComponent implements OnInit {
