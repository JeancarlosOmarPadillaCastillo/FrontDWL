...
} from '../../../../trabajador/components/gestionEPP/dialog-generarSolicitudTrabajador/generar-solicitud-trabajador.component';
import {MatDialog} from '@angular/material/dialog';
import {
  AdjuntarDesgasteEppComponent
} from '../../../../trabajador/components/gestionEPP/adjuntar-desgaste-epp/adjuntar-desgaste-epp.component';
...
@Component({
  ...
  templateUrl: './solicitar-epp-sst-2.component.html',
  styleUrl: './solicitar-epp-sst-2.component.css'
})
export class SolicitarEppSst2Component implements OnInit{
