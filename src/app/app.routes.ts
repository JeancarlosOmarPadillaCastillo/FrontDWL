...
import {
  AsignacionEppGaf3Component
} from './gaf/components/gestionEPP/asignacion-epp-gaf3/asignacion-epp-gaf3.component';
import {
...
export const routes: Routes = [
  ...
  { path: 'ver-historial-trabajador', component: VerHistorialTrabajadorComponent },
  { path: 'ver-historial-sst', component: VerHistorialEppSstComponent },
  ...
  { path: 'asignacion-epp-gaf-3', component: AsignacionEppGaf3Component },
